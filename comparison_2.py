...
def overlay_mask(image, mask, alpha=0.5, colormap='viridis'):
    """
...
if __name__ == "__main__":
    ...
    original_image_path = "1_whitelist_pair/image_Video12_frame009750.png"
    mask_path = "1_whitelist_pair/label_Video12_frame009750.png"
    ...
    # Create a composite image using the overlay function
    composite_image = overlay_mask(original_image, mask, alpha=0.7, colormap='viridis')
